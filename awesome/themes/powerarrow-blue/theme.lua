...
theme.weather = lain.widget.weather({
    city_id = 4843353, -- South Windsor, CT
	units = "imperial",
	APPID = "878249d3d2f0c1f122d5dcb330c55014",
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("alpha", DARK_BLUE),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), DARK_BLUE),
            arrow(DARK_BLUE, LIGHT_BLUE),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#889FA7"),
            arrow("#889FA7", "#497B96"),
